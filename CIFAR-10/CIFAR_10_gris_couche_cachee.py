import numpy as np
from preprocessing import X_gris_test, X_gris_train, Y_test, Y_train
...
np.random.seed(42)
W1 = np.random.randn(p1, 1024)*0.01
b1 = np.zeros([p1,1])
...
def train(x, y, W1, b1, W2, b2, lr=0.01, epochs=10, batch_size=64):
    ...
    return W1, b1, W2, b2
W1, b1, W2, b2 = train(X_gris_train, Y_train, W1, b1, W2, b2)
...
print(f"taux d'erreur (train) = {evaluate(X_gris_train, Y_train, W1, b1, W2, b2):.2f}%")
#68.09%
print(f"taux d'erreur (test) : {evaluate(X_gris_test, Y_test, W1, b1, W2, b2):.2f}%")
#68.51%